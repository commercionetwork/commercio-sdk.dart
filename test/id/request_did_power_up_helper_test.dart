    ...
    test('"fromWallet()" returns a well-formed "RequestDidPowerUp" object.',
        ...
        "result": {
          ...
          "did_document": {
            ...
            "publicKey": [
              ...
              {
                "id": "did:com:14ttg3eyu88jda8udvxpwjl2pwxemh72w0grsau#keys-2",
            ...
            "proof": {
              ...
              "created": "2020-05-12T09:17:44.163534708Z",
              "proofPurpose": "authentication",
              "controller": "did:com:14ttg3eyu88jda8udvxpwjl2pwxemh72w0grsau",
              "verificationMethod":
                  "did:com:pub1addwnpepqdnzje8vxh4xrdg8aa6lsjegukqhtmrjeux26z7zlk5zry8fp04rcw3vxec",
              "signatureValue":
                  "MnhISqHW6N0ziIwKJ+gPgfSUPdE4E+/fPSRgff/xZTwe3d9Jqpynhdb09ma3qEKZrVwNaThdvOIOe6a/m4RIRg=="
            }
          }
        }
      };
      ...
      Network.client = MockClient((request) {
        if (request.url.path == '$lcdUrl/government/tumbler') {
          return Future.value(Response(jsonEncode(addressJson), 200));
        }
        return Future.value(Response(jsonEncode(identityJson), 200));
      });
